...
- ✅ **Mécanisme validé** : **36 tests** (unitaires + intégration + property/fuzz + doctests + calibration λ + CCOS), clippy `-D warnings` clean, CI
...
git clone https://github.com/CHECKUPAUTO/SLHAv2.git
cd SLHAv2
cargo test                              # 36 tests, doivent passer
cargo fmt --all --check

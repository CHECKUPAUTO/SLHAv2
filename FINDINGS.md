...
- **Le mécanisme est correct et implémentable.** Tuile 128 o sans gaspillage,
  ...
  **prouvés équivalents** (36 tests dont property/fuzz, clippy `-D warnings`, CI).
...
---
*Réf. : crate `scirust/` (36 tests dont property/fuzz + doctests + calibration λ + CCOS, criterion, CI), paper `SLHAv2.md` §1–8.*
